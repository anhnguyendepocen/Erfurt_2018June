...
## Bad
```{r, eval=F}
mean(subset((data.frame(c('a','b'),runif(1000,
...
<font size="6" color="#F62D73"><a href="https://github.com/therbootcamp/Erfurt_2018June/blob/master/_sessions/_data/data_BaselRBoocamp_Day1.zip?raw=true">download link</a></font>
