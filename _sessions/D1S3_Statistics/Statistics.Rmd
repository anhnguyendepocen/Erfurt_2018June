...
knitr::include_graphics("../_image/list_tab.png")
```
...
```{r, echo = FALSE, out.width = "70%", fig.align="center"}
knitr::include_graphics("../_image/broom_hex.png")
```
...
knitr::include_graphics("../_image/balloons.png")
```
...
knitr::include_graphics("../_image/lavaan_ss.jpg")
```


```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("../_image/BayesFactor_ss.png")
```
