...
The data for this case study are in three separate files: `dimarta_biomarker.csv`, `dimarta_demographics.csv`, and  `dimarta_trial.csv`. The files are located in the `data_BaselRBootcamp_Day1.zip` folder available through the schedule.  Here are descriptions of the columns in these files:
