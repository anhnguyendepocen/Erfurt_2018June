...
```{r, echo = TRUE, fig.align = 'center', eval = TRUE, fig.cap= "Source: https://www.rstudio.com/", out.width = "30%"}
...
```{r, echo = TRUE, fig.align = 'center', eval = TRUE, fig.cap= "https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf", out.width = "60%"}
...
1. Open your bootcamp R project. Open a new R script and save it under the name `plotting_practical.R` in your `2_Code` folder.

2. At the top of your script load the `tidyverse` package (which includes ggplot2).
...
11. The `ggthemes` package contains many additional themes. If you don't have the package already, install it by running `install.packages("ggthemes")`. Then, look at the `ggthemes()` vignette by running the following code:
