...
# Code to knit slides
xaringan::inf_mr('_sessions/D2S3_EfficientCode/EfficientCode.Rmd')
baselers <- read_csv("data/")
```
...
link <- 'https://raw.githubusercontent.com/therbootcamp/therbootcamp.github.io/master/_sessions/_data/titanic.csv'
